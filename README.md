...
### Выполнение
#### ([перейти к скрипту](https://github.com/Mihon99/Homework8_Linux/blob/main/delfiletodir.sh))
...
### Выполнение
#### ([перейти к скрипту](https://github.com/Mihon99/Homework8_Linux/blob/main/ownersort.sh))
